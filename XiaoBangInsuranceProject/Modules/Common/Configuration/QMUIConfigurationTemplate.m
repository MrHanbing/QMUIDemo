...
#pragma mark - Global Color
    ...
    // UIColorDisabled : 全局 disabled 的颜色，一般用于 UIControl 等控件
    QMUICMI.backgroundColor = [UIColor qmui_colorWithHexString:@"#FFFFFF"];
    //UIColorWhite;                                     // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
    QMUICMI.maskDarkColor = [UIColor qmui_colorWithHexString:@"#FFFFFF"];                 // UIColorMask : 深色的背景遮罩，默认用于 QMAlertController、QMUIDialogViewController 等弹出控件的遮罩
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBarTintColor = UIColorWhite;//[UIColor qmui_colorWithHexString:@"#607D8B"];                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    QMUICMI.navBarTintColor =  UIColorBlack;//UIColorWhite;                                     // NavBarTintColor : QMUINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = UIColorBlack;//NavBarTintColor;                                 // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    ...
    QMUICMI.navBarBackIndicatorImage = UIImageMake(@"nav_back");//[UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(12, 20) tintColor:NavBarTintColor];                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片，图片尺寸建议为(13, 21)，否则最终的图片位置无法与系统原生的位置保持一致
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarTintColor = QMUICMI.yellowColor;//UIColorMake(4, 189, 231);                         // TabBarTintColor : UITabBar 的 tintColor
    QMUICMI.tabBarItemTitleColor =[UIColor blackColor]; //UIColorGray6;                                // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = [UIColor blackColor];                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleFont = [UIFont systemFontOfSize:12];                                          // TabBarItemTitleFont : UITabBarItem 的标题字体
